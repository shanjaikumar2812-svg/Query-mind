...
window.QMApi = (function () {
  ...
  /* Load one of the curated sample datasets shipped with the app. */
  function loadSample(sampleKey) {
    return fetch(`/upload/sample/${encodeURIComponent(sampleKey)}`, {
      method: "POST",
  ...
  return { uploadFile, loadSample, askQuestion, getHistory, getProfile, getForecast, deleteDataset };
})();
